...
WELCOME_BACK_PHRASES = [
    "Ну я вернулся, скучали?",
    "Соскучились по папочке? Я снова с вами.",
    "Кто звал? А, никто. Ну я всё равно тут.",
    "Отдохнул, теперь буду доёбывать с новыми силами.",
    "I'm back. Опять.",
    "Думали, навсегда замолчал? Хрен вам.",
    "Тишина закончилась. Терпите дальше.",
    "Вылез из астрала. Чё пропустил?",
]
...
def _welcome_back_phrase() -> str:
    return random.choice(WELCOME_BACK_PHRASES)
